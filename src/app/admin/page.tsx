  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-slate-900/95 backdrop-blur-xl border-b border-slate-800 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-white font-bold text-sm">{t.admin.panelTitle}</h1>
      ...
      {isMobileMenuOpen && (
        ...
        >
          <div 
            className={`absolute top-16 ${isRTL ? 'right-0' : 'left-0'} w-72 max-w-[85vw] h-[calc(100vh-4rem)] bg-slate-900/98 backdrop-blur-xl border-slate-800 ${isRTL ? 'border-l' : 'border-r'} p-4 overflow-y-auto`}
      ...
      <div className="flex min-h-screen pt-16 lg:pt-0">
        ...
        <aside className={`hidden lg:flex w-72 bg-slate-900/50 backdrop-blur-xl ${isRTL ? 'border-l' : 'border-r'} border-slate-800 p-6 flex-col`}>
          {/* Logo */}
          <div className="mb-6">
